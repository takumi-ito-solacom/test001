...
<html lang="ja">
  ...
  <body class="p-3">
    ...
    <form method="post" action="/edit">
      ...
      <div class="form-group">
        <label for="writerCodeInput">作者</label>
        <input type="text" class="form-control" id="writerCodeInput" name="writerCode"value="{{ $article->writer_code }}">
      </div>
      <div class="form-group">
        <label for="scoreInput">評価点数</label>
        <input type="text" class="form-control" id="scoreInput" name="score"value="{{ $article->score }}">
      </div>
